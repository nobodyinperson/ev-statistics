...
xpath_header = "|".join([
    "//div[@class='post-content']//strong/text()",
    "//div[@class='post-content']//h3/text()"
    ])
...
# delete garbage column
try:             del data[UNKNOWN_HEADER_COLUMN]
...
writer = csv.DictWriter( # a CSV writer
    ...
    dialect = CSV_DIALECT, # custom dialect
    )
